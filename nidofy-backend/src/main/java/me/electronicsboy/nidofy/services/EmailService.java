...
public class EmailService {
    ...
    public static final String ADMINACCOUNTPWD_BODY = "<table width=\"100%%\" cellpadding=\"0\" cellspacing=\"0\" style=\"max-width: 600px; margin: auto; font-family: Arial, sans-serif; border: 1px solid #dee2e6; background-color: #ffffff;\">\r\n"
    		+ "  <tr>\r\n"
    		+ "    <td style=\"background-color: #0d6efd; padding: 20px; text-align: center;\">\r\n"
    		+ "      <h2 style=\"color: #ffffff; margin: 0;\">Forgot password?</h2>\r\n"
    		+ "    </td>\r\n"
    		...
    		+ "  <tr>\r\n"
    		+ "    <td style=\"padding: 20px;\">\r\n"
    		+ "      <p style=\"font-size: 16px; color: #212529;\">Hi <strong>Admin</strong>,</p>\r\n"
    		+ "      <p style=\"font-size: 16px; color: #212529;\">\r\n"
    		+ "        Please use the username <strong>%s</strong> and password <strong>%s</strong> to login.\r\n"
    		+ "      </p>\r\n"
    		+ "      <p style=\"font-size: 16px; color: #212529;\">Regards,<br>The Admin Team</p>\r\n"
    		+ "    </td>\r\n"
    		+ "  </tr>\r\n"
